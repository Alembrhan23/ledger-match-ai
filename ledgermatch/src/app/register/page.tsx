...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    if (error) {
      ...
      setSuccessMsg('✅ Registered! Please check your email to confirm your account.');
      ...
      <div className="w-full max-w-6xl flex shadow-2xl rounded-xl overflow-hidden border border-blue-100 bg-white">
        ...
        <div className="hidden lg:flex w-1/2 bg-blue-800 text-white flex-col justify-center items-center px-12 py-20">
          ...
          <p className="text-xl text-blue-100 leading-relaxed text-center">
            ...
            <br /> Upload. Match. Reconcile.
          </p>
        </div>

        {/* Right Panel */}
        <div className="w-full lg:w-1/2 p-12 flex flex-col justify-center">
          <h2 className="text-4xl font-bold text-blue-900 mb-10 text-center">Create an Account</h2>
          ...
          {successMsg && (
            <div className="bg-green-100 border border-green-300 text-green-700 px-4 py-3 rounded mb-6 text-lg text-center">
              {successMsg}
            </div>
          )}
